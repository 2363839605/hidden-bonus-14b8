...
```bash
npm create cloudflare@latest -- --template=cloudflare/templates/hidden-bonus-14b8
```

A live public deployment of this template is available at [https://hidden-bonus-14b8.templates.workers.dev](https://hidden-bonus-14b8.templates.workers.dev)
